...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES ON *.* TO `updater`@'localhost';
CREATE USER 'updater'@'%' IDENTIFIED BY 'shakespeare'; GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES ON *.* TO `updater`@'%';
